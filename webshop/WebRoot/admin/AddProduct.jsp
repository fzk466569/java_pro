...
<div class="content">
	...
	<tr>
		...
		<td colspan="3"><input type="text" id="product_name" name="product_name" value="" class="inputall input600" maxlength="36" /></td>
	...
	<tr>
		...
		<td width="240"><input id="product_smoney" type="text" name="product_smoney" value="0" class="inputall input100" /> <span class="c888">元</span></td>
		
	</tr>
	<tr>
		<td align="right">关键词：</td>
		<td><input type="text" name="product_key" value="" class="inputall input100" /> <span class="c888">件</span></td>
	</tr>
	<tr>
		<td align="right">剩余库存：</td>
		<td><input type="text" name="product_num" value="" class="inputall input100" /> <span class="c888">件</span></td>
		<td align="right"></td>
		<td><input type="hidden" name="product_mark" value="" class="inputall input100" /></td>
	</tr>
		<tr>
	...
	<div class="mat10 mab10">
		...
		<input type="submit" value="提 交" class="tjbtn" style="margin-left:325px" />
	</div>
	</form>
</div>
<style type="text/css">
